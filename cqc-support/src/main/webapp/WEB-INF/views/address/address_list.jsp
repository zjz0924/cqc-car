...
<html>
	<head>
		...
		<script type="text/javascript">
			var url = "${ctx}/address/getList";
			var detailUrl = "${ctx}/address/detail";
			var datagrid = "addressTable";
	...
	<body>
		<div style="margin-top: 15px; padding-left: 20px; margin-bottom: 10px;font-size:12px;">
			地址：<input id="q_name" name="q_name" class="easyui-textbox" style="width: 150px;">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:80px;" onclick="doSearch()">查询</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-clear'" style="width:80px;" onclick="doClear()">清空</a>
		</div>
				
		<div style="margin-top:10px;">
			<table id="addressTable" style="height:auto;width:auto"></table>
		</div>
