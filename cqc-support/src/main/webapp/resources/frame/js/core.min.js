    ...
    */
    ...
    e(".nav-sidebar a").click(function(t) {
        ...
        if (e(this).parent().find("ul").size() != 0) {
            ...
            e(this).parent().find("ul").first().slideToggle("slow",
            function() {
                dropSidebarShadow()
            });
            e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("slow",
            function() {
        	...
        	e(".nav-sidebar li").removeClass("active");
        	e(this).parent().addClass("active");
        } 
    ...
    e("#main-menu-toggle").click(function() {
        ...
        e("body").hasClass("sidebar-hide") ? e("#navbar-header-title").hide() : e("#navbar-header-title").show()
    });
